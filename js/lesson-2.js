...
//   return sum / count;
// }
// console.log(caclculateAverage(1, 2, 3, 10, 8, 7)); // 5.1666...
...
//     this.mood = newMood;
//   },
//   updateUserHobby(newHobby) {
//     this.hobby = newHobby;
//   },
//   updateUserPremium(newPremium) {
...
// user.updateUserHobby("skydiving");
// user.updateUserPremium(false);
// user.userInfo();
// console.table(user);
