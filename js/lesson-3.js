...
// const numb = numbers.map((num) => num * num);
// console.log(numb);
...
// const val = data.flatMap((value) => value.values);
// console.log(val);
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
// const result = peoples.some((people) => {
...
// const numbersArray = [4, 2, 5, 1, 3, 22];
...
// console.log(result);
// const result1 = users.reduce((acc, user) => {
//   console.log(acc);
//   if (user.age > 20) {
//     acc.push(user.name);
//   }
